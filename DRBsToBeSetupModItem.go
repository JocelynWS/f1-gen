...
type DRBsToBeSetupModItem struct {
...
func (ie *DRBsToBeSetupModItem) Encode(w *aper.AperWriter) (err error) {
...
func (ie *DRBsToBeSetupModItem) Decode(r *aper.AperReader) (err error) {
