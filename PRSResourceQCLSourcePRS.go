...
type PRSResourceQCLSourcePRS struct {
	QCLSourcePRSResourceSetID PRSResourceSetID `mandatory`
	QCLSourcePRSResourceID    *int64           `lb:0,ub:63,optional`
	// IEExtensions * `optional`
}

func (ie *PRSResourceQCLSourcePRS) Encode(w *aper.AperWriter) (err error) {
	...
	if err = ie.QCLSourcePRSResourceSetID.Encode(w); err != nil {
...
func (ie *PRSResourceQCLSourcePRS) Decode(r *aper.AperReader) (err error) {
	...
	if err = ie.QCLSourcePRSResourceSetID.Decode(r); err != nil {
