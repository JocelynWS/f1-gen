...
type ExtendedAvailablePLMNItem struct {
	PLMNIdentity []byte `lb:3,ub:3,mandatory`
	// IEExtensions * `optional`
}

func (ie *ExtendedAvailablePLMNItem) Encode(w *aper.AperWriter) (err error) {
...
func (ie *ExtendedAvailablePLMNItem) Decode(r *aper.AperReader) (err error) {
