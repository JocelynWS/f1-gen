...
type BHChannelsToBeModifiedItem struct {
...
func (ie *BHChannelsToBeModifiedItem) Encode(w *aper.AperWriter) (err error) {
...
func (ie *BHChannelsToBeModifiedItem) Decode(r *aper.AperReader) (err error) {
