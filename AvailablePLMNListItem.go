...
type AvailablePLMNListItem struct {
	PLMNIdentity []byte `lb:3,ub:3,mandatory`
	// IEExtensions * `optional`
}

func (ie *AvailablePLMNListItem) Encode(w *aper.AperWriter) (err error) {
...
func (ie *AvailablePLMNListItem) Decode(r *aper.AperReader) (err error) {
