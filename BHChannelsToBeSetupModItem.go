...
type BHChannelsToBeSetupModItem struct {
...
func (ie *BHChannelsToBeSetupModItem) Encode(w *aper.AperWriter) (err error) {
...
func (ie *BHChannelsToBeSetupModItem) Decode(r *aper.AperReader) (err error) {
