...
type BHChannelsSetupItem struct {
	BHRLCChannelID aper.BitString `lb:16,ub:16,mandatory`
	// IEExtensions * `optional`
}

func (ie *BHChannelsSetupItem) Encode(w *aper.AperWriter) (err error) {
...
func (ie *BHChannelsSetupItem) Decode(r *aper.AperReader) (err error) {
