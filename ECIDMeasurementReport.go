...
func (msg *ECIDMeasurementReport) Decode(wire []byte) (err error, diagList []CriticalityDiagnosticsIEItem) {
	...
	r.ReadBool()
	decoder := ECIDMeasurementReportDecoder{
		msg:  msg,
...
type ECIDMeasurementReportDecoder struct {
	msg      *ECIDMeasurementReport
	diagList []CriticalityDiagnosticsIEItem
	list     map[aper.Integer]*F1apMessageIE
}

func (decoder *ECIDMeasurementReportDecoder) decodeIE(r *aper.AperReader) (msgIe *F1apMessageIE, err error) {
	var id int64
	var c uint64
	var buf []byte
