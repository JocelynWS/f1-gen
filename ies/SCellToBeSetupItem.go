...
type SCellToBeSetupItem struct {
...
func (ie *SCellToBeSetupItem) Encode(w *aper.AperWriter) (err error) {
...
func (ie *SCellToBeSetupItem) Decode(r *aper.AperReader) (err error) {
