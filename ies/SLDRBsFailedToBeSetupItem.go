...
type SLDRBsFailedToBeSetupItem struct {
	SLDRBID int64  `lb:1,ub:512,mandatory,valueExt`
	Cause   *Cause `optional`
	// IEExtensions * `optional`
}

func (ie *SLDRBsFailedToBeSetupItem) Encode(w *aper.AperWriter) (err error) {
...
func (ie *SLDRBsFailedToBeSetupItem) Decode(r *aper.AperReader) (err error) {
