...
type BHChannelsFailedToBeSetupItem struct {
	BHRLCChannelID aper.BitString `lb:16,ub:16,mandatory`
	Cause          *Cause         `optional`
	// IEExtensions * `optional`
}

func (ie *BHChannelsFailedToBeSetupItem) Encode(w *aper.AperWriter) (err error) {
...
func (ie *BHChannelsFailedToBeSetupItem) Decode(r *aper.AperReader) (err error) {
