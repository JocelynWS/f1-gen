...
func (msg *PositioningActivationFailure) Encode(w io.Writer) (err error) {
	var ies []F1apMessageIE
	if ies, err = msg.toIes(); err != nil {
		err = msgErrors(fmt.Errorf("PositioningActivationFailure"), err)
		return
	}
	return encodeMessage(w, F1apPduUnsuccessfulOutcome, ProcedureCode_PositioningActivation, Criticality_PresentReject, ies)
}
func (msg *PositioningActivationFailure) toIes() (ies []F1apMessageIE, err error) {
	ies = []F1apMessageIE{}
...
func (msg *PositioningActivationFailure) Decode(wire []byte) (err error, diagList []CriticalityDiagnosticsIEItem) {
	defer func() {
		if err != nil {
			err = msgErrors(fmt.Errorf("PositioningActivationFailure"), err)
		}
	...
	r.ReadBool()
	decoder := PositioningActivationFailureDecoder{
		msg:  msg,
...
type PositioningActivationFailureDecoder struct {
	msg      *PositioningActivationFailure
	diagList []CriticalityDiagnosticsIEItem
	list     map[aper.Integer]*F1apMessageIE
}

func (decoder *PositioningActivationFailureDecoder) decodeIE(r *aper.AperReader) (msgIe *F1apMessageIE, err error) {
	var id int64
	var c uint64
	var buf []byte
