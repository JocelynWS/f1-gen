...
func (ie *NGRANAllocationAndRetentionPriority) Encode(w *aper.AperWriter) (err error) {
...
func (ie *NGRANAllocationAndRetentionPriority) Decode(r *aper.AperReader) (err error) {
