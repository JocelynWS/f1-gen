...
type DeactivateTrace struct {
	...
	TraceID       []byte `lb:8,ub:8,mandatory,ignore`
}
...
func (decoder *DeactivateTraceDecoder) decodeIE(r *aper.AperReader) (msgIe *F1apMessageIE, err error) {
	var id int64
	var c uint64
	var buf []byte
